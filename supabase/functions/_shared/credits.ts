...
const GMI_MODEL_COSTS: Record<string, number> = {
  ...
  'gmi/gpt-image-2': 6,
  'gmi/gpt-image-2-edit': 6,
  'gmi/gemini-3-pro-image-preview': 14,
  'gmi/luma-uni-1.1': 1,
  // Video
  ...
  'gmi/wan-2.7-i2v': 22,
  'gmi/wan-2.7-r2v': 22,
  'gmi/happyhorse-1.0-i2v': 140,
  'gmi/veo-3.1-generate-001': 320,
  'gmi/veo-3-1-lite-generate-001': 40,
  ...
  'gmi/seedance-2.0-t2v': 30,
  'gmi/seedance-2.0-i2v': 30,
  'gmi/seedance-2.0-fast-t2v': 20,
  'gmi/seedance-2.0-fast-i2v': 20,
  // Text
