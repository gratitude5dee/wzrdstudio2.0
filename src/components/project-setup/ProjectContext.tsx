...
const defaultProjectData: ProjectData = {
  ...
  baseImageModel: 'gmi/gpt-image-2',
  baseVideoModel: 'gmi/seedance-2.0-i2v',
      ...
      .upsert(
        {
          ...
          base_image_model: projectData.baseImageModel || 'gmi/gpt-image-2',
          base_video_model: projectData.baseVideoModel || 'gmi/seedance-2.0-i2v',
    ...
    try {
      ...
      const structuredPayload = {
        ...
        settings: {
          ...
          baseImageModel: projectData.baseImageModel || 'gmi/gpt-image-2',
          baseVideoModel: projectData.baseVideoModel || 'gmi/seedance-2.0-i2v',
