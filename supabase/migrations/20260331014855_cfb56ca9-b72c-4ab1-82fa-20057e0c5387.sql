...
-- Shadow evaluation + project observability foundation
...
-- Drop old evaluation_runs columns that conflict (if table existed from old schema)
-- The types.ts already has the new shape; we need the DB to match
