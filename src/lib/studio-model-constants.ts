...
const gmiImageGenerationModels: StudioModel[] = [
  ...
  },
  {
    id: 'gmi/gpt-image-2',
    name: 'GPT Image 2',
    description: 'OpenAI GPT Image 2 — strong text rendering and photorealism.',
    credits: 6,
    time: '~15s',
    icon: 'image',
    badge: 'Quality',
    ...
    workflowType: 'text-to-image',
    uiGroup: 'generation',
    supports: ['prompt', 'size', 'quality', 'output_format', 'n'],
    defaults: { size: '1024x1024', quality: 'medium', output_format: 'png', n: 1 },
  },
  {
    id: 'gmi/gpt-image-2-edit',
    name: 'GPT Image 2 Edit',
    description: 'GPT Image 2 image editing & inpainting (mask-based).',
    credits: 6,
    time: '~15s',
    icon: 'image',
    provider: 'gmi-cloud',
    ...
    uiGroup: 'advanced',
    supports: ['prompt', 'image', 'mask', 'size', 'quality', 'n'],
    defaults: { size: '1024x1024', quality: 'medium', n: 1 },
  },
  {
    id: 'gmi/gemini-3-pro-image-preview',
    name: 'Gemini 3 Pro Image',
    description: 'High-quality Google Gemini 3 Pro image generation with multi-image references.',
    credits: 14,
    time: '~12s',
    icon: 'image',
    badge: 'Premium',
    ...
    workflowType: 'text-to-image',
    uiGroup: 'generation',
    supports: ['prompt', 'image', 'image_size', 'aspect_ratio', 'image_output_format'],
    defaults: { image_size: '1K', aspect_ratio: '1:1', image_output_format: 'png' },
  },
  {
    id: 'gmi/luma-uni-1.1',
    name: 'Luma Uni 1.1',
    description: 'Luma Uni 1.1 — fast text-to-image and image editing.',
    credits: 1,
    time: '~6s',
    icon: 'image',
    badge: 'Fast',
    ...
    workflowType: 'text-to-image',
    uiGroup: 'generation',
    supports: ['prompt', 'image', 'aspect_ratio'],
...
const gmiVideoGenerationModels: StudioModel[] = [
  ...
  },
  {
    ...
    description: 'Cinematic image-to-video with strong fidelity. $0.28/sec.',
    credits: 140,
    time: '~80s',
    icon: 'video',
    badge: 'Premium',
    ...
    workflowType: 'image-to-video',
    uiGroup: 'generation',
    supports: ['prompt', 'first_frame', 'last_frame', 'image_url', 'resolution', 'duration', 'prompt_extend', 'watermark', 'seed', 'negative_prompt'],
    defaults: { duration: 5, resolution: '1080P', prompt_extend: true, watermark: false },
  },
  {
    id: 'gmi/veo-3.1-generate-001',
    name: 'Veo 3.1',
    description: "Google's flagship Veo 3.1 video generation. $0.40/sec.",
    credits: 320,
    time: '~120s',
    icon: 'video',
    badge: 'Premium',
    ...
    workflowType: 'image-to-video',
    uiGroup: 'generation',
    supports: ['prompt', 'image', 'lastFrame', 'reference_image', 'durationSeconds', 'aspectRatio', 'generateAudio', 'negativePrompt', 'personGeneration', 'seed', 'resolution'],
    defaults: { durationSeconds: 8, aspectRatio: '16:9', generateAudio: true, resolution: '1080p', personGeneration: 'allow_all' },
  },
  {
    id: 'gmi/veo-3-1-lite-generate-001',
    name: 'Veo 3.1 Lite',
    description: 'Cost-effective Veo 3.1 variant. From $0.05/sec (720p+audio).',
    credits: 40,
    time: '~60s',
    icon: 'video',
    badge: 'Fast',
    ...
    workflowType: 'image-to-video',
    uiGroup: 'generation',
    supports: ['prompt', 'image', 'lastFrame', 'durationSeconds', 'aspectRatio', 'generateAudio', 'personGeneration', 'seed', 'resolution'],
    defaults: { durationSeconds: 8, aspectRatio: '16:9', generateAudio: true, resolution: '720p', personGeneration: 'allow_all' },
  },
];
